                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSourceMaterias" runat="server" ConnectionString="<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>" SelectCommand="SELECT * FROM [Materias] WHERE ([idCarrera] = @idCarrera)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="carrera" PropertyName="SelectedValue" Name="idCarrera" Type="Int32"></asp:ControlParameter>
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </div>
                                 <div class="col-2">
