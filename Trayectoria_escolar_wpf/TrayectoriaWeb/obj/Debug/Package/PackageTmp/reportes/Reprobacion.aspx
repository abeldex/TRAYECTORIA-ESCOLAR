<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reprobacion.aspx.cs" Inherits="TrayectoriaWeb.reportes.Reprobacion" %>
  ...
  <body data-provide="pace">
            ...
            <a class="menu-link" href="#">
              ...
              <li class="menu-item">
                ...
                <a class="menu-link" href="Eficiencias.aspx">
                  ...
                  <li class="menu-item">
                <a class="menu-link" href="REPROBACION.aspx">
                  <span class="dot"></span>
    ...
    <main>
       ...
       <form id="formPrincipal" runat=server>
           <div class="row">
                <div class="col-md-12">
                    <h1>Indices y Tasas de Reprobación Ordinarios</h1>
        ...
        <div class="row" id="i_reportes">
            ...
            <div class="card">
              <div class="card-header bg-info">
                <h5 class="card-title text-white"><b>Indice de REPROBACION en Ordinarios PERIODO I</b> </h5>          
              </div>      
                  <div class="card-body">    
													...
													<table id="tabla1" class="table table-responsive table-striped compact" data-provide="datatables">
														...
														<tr>
															<th>Grado</th>
															<th>Indice de REPROBACION en ordinario</th>
														</thead>
														<tbody>
                                                            <tr>
															   <td>1ero</td>
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice1" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice2" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice3" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice4" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice5" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
            ...
            <div class="card">
              <div class="card-header bg-info">
                <h5 class="card-title text-white"><b>Indice de REPROBACION en Ordinarios PERIODO II</b> </h5>          
              </div>      
                  <div class="card-body">    
														...
														<tbody>
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice6" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice7" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice8" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>  
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlIndice9" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Indices_reprobacion_ord_1" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
            ...
            <div class="card">
              <div class="card-header bg-info">
                <h5 class="card-title text-white"><b>TASA DE REPROBACION ORDINARIO PERIODO I</b> </h5>          
              </div>      
                  <div class="card-body">    
														...
														<tbody>
                                                            <tr>
															   <td>1ero</td>
                                                                   ...
                                                                   <asp:Repeater ID="Repeater10" runat="server" DataSourceID="SqlTasa1">
                                                                        <ItemTemplate>
                                                                        <td style="text-align:center; font-size:10px;"><span style="font-weight:400"><%# Eval("%") %>%</span><br><%# Eval("NombreMateria") %><br />Reprobados: <%# Eval("Reprobados") %> de <%# Eval("Total") %></td>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>     
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa1" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="1" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
                                                             ...
                                                             <tr>
															   <td>2do</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa2" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="3" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
                                                            ...
                                                            <tr>
															   <td>3er</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa3" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="5" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
                                                             ...
                                                             <tr>
															   <td>4to</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa4" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="7" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
                                                            ...
                                                            <tr>
															   <td>5to</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa5" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="9" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
            ...
            <div class="card">
              <div class="card-header bg-info">
                <h5 class="card-title text-white"><b>TASA DE REPROBACION ORDINARIO PERIODO II</b> </h5>          
              </div>      
                  <div class="card-body">    
														...
														<tbody>
                                                            <tr>
															   <td>1ero</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa6" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="2" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
                                                             ...
                                                             <tr>
															   <td>2do</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa7" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="4" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
                                                            ...
                                                            <tr>
															   <td>3er</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa8" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="6" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
                                                             ...
                                                             <tr>
															   <td>4to</td>
                                                                   ...
                                                                   <asp:SqlDataSource runat="server" ID="SqlTasa9" ConnectionString='<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>' SelectCommand="Sp_Tasas_Reprobacion" SelectCommandType="StoredProcedure">
                                                                  <SelectParameters>
                                                                      <asp:QueryStringParameter DefaultValue="8" QueryStringField="periodo" Name="periodo" Type="Int32"></asp:QueryStringParameter>
                                                                      <asp:QueryStringParameter DefaultValue="null" Name="cohorte" QueryStringField="cohortes" />
                                                                      <asp:QueryStringParameter DefaultValue="0" Name="CarreraIngreso" QueryStringField="carrera" Type="Int32" />
    ...
    <!-- END Main container -->
      <script type="text/javascript">
          ...
          $("#btnBuscar").click(function () {
              ...
              var QueryString = "reportes/Reprobacion.aspx?carrera=" + carrera + "&cohortes=" + cohortes;
              //alert(QueryString);
